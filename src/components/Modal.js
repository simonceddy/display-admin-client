function Modal({ children, onClose }) {
  return (
    <div
      className="absolute w-full h-inherit top-0 left-0 flex flex-row justify-center items-center z-20"
    >
      <div
        role="presentation"
        onClick={onClose}
        className="z-30 absolute w-full h-full bg-slate-700 bg-opacity-60"
      />
